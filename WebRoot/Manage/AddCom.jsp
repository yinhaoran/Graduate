			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right" >
					...
					<ul class="dropdown-menu">
						<li class="divider"></li>
						<li><a href="/Manage/login.jsp">登录界面</a></li>
					</ul>
				</div>
				<!-- user dropdown ends -->
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="ManageComServlet?action=addCom" method="post" ENCTYPE="multipart/form-data">
							<fieldset>
							<div class="control-group">
							  ...
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">商品名称:</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="comname">
							  ...
							  <div class="control-group success">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="price">
								  <span class="help-inline">Woohoo!</span>
								</div>
							  </div>
							  <div class="control-group success">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="inventory">
								  <span class="help-inline">Woohoo!</span>
								</div>
							  </div>
							  <div class="control-group">
							  <label class="control-label" for="textarea2">添加描述</label>
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" rows="3" name="describe"></textarea>
							  </div>
							  </div>
							   <div class="control-group">
