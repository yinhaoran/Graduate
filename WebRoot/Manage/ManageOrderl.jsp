				...
				<div class="box span12">
					...
					<div class="box-content">
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">订单id:<span class="help-inline">${order.orderid}</span></label>
							  </div>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">订单成交时间: <span class="help-inline">${order.transtime}</span></label>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">用户id:<span class="help-inline">${order.userid}</span></label>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">订单状态: <span class="help-inline">${order.orderstatus}</span></label>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">买家留言:<span class="help-inline">${order.userwords}</span></label>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">买的数量:<span class="help-inline">${order.ordercount}</span></label>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">用户地址ID:<span class="help-inline">${order.addressid}</span></label>
							  <div class="form-actions">
								<a href="${basePath}ManageOrderServlet?action=findAllOrder" class="btn btn-primary">返回主页面</a>
							  </div>
