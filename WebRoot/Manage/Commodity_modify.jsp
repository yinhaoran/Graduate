			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i>修改商品信息</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" method="post" action="ManageComServlet?action=doUpdate" ENCTYPE="multipart/form-data">
							<fieldset>
								<input type="hidden" name="comid" value="${commodity.comid}">
								<div class="control-group">
								<label class="control-label" for="selectError3">商品分类:</label>
								<div class="controls">
								  <select id="selectError3" name="sorts" value="${sort.sortid}">
							  ...
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">商品名:</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="comname" value="${commodity.comname}">
							  ...
							  <div class="control-group success">
								...
								<div class="controls">
								  <input type="text" id="inputSuccess" name="price" value="${commodity.price }">
								</div>
							  </div>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">库存:</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="inventory" value="${commodity.inventory }">
								</div>
							  </div>
							  <div class="control-group success">
								<label class="control-label" for="inputSuccess">描述:</label>
								<div class="controls">
								  <input type="text" id="inputSuccess" name="describe" value="${commodity.describe }">
								</div>
							  </div>
							   <div class="control-group">
