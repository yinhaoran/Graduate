		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-3 col-md-6">
					<form class="form-horizontal" method="post" onsubmit="return checkLogin()" action="<%=basePath %>ManageLoginServlet?action=login" style="width: 450px;">
