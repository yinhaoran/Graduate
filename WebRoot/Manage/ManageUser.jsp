						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <c:forEach items="${userlist}" var="userlist">
							<tr>
								...
								<c:if test="${userlist.sign==0}">
									<td class="center">普通用户</td>
								</c:if>
								<c:if test="${userlist.sign==1}">
								...
								<td class="center">
									...
									<a class="btn btn-info" href="ManageUserServlet?action=update&userid=${userlist.userid }">
										<i class="icon-edit icon-white"></i>  
										编辑                                            
									</a>
									<a class="btn btn-danger" href="javascript:if(confirm('是否删除')){window.location='ManageUserServlet?action=delete&userid=${userlist.userid }'}" >
