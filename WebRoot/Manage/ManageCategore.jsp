...
<head>
	...
	<script type="text/javascript">
		function addCategory(){
			window.location.href='<%=request.getContextPath()%>/Manage/addCategory.jsp';
		}
	</script>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
						  <c:forEach var="sorts" items="${sortlist }">
							<tr>
								<td class="center">${sorts.sortname}</td>
								<td class="center">
									<a class="btn btn-danger" href="<%=basePath%>ManageCategoreServlet?action=DeleteCategory&sortid=${sorts.sortid}">
