...
<body>
	...
	<!-- topbar ends -->
		<div class="container-fluid">
			...
			<jsp:include page="elements/left.jsp" />
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i>留言管理</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<%-- <jsp:useBean id="com" class="com.sys.service.CommentService"> --%>
								<c:forEach items="${commentlist}" var="comment">
									<tr>
										<td>${comment.content}</td>
										<td class="center">${comment.username}</td>
										<td class="center">
											<span>${comment.createdate}</span></td>
										<td class="center">
										<%-- <jsp:setProperty name="com" property="comid" value="${commentlist.comid}" />  --%>
											<span> ${comment.commodity.comname} </span>
										</td>
										<td class="center">
												<a class="btn btn-danger" href="javascript:if(confirm('是否删除')){window.location='ManageCommentServlet?action=delete&commentid=${comment.commentid} '}">
