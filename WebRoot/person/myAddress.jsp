...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <select name="province" id="province" runat="server" onchange="selectprovince(this);" style=" width:95px;"></select>
    <select name="city" id="city" runat="server" style=" width:95px;"></select>
