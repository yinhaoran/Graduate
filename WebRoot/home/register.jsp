...
<body>
	...
	<div class="res-banner">
						...
						<div class="am-tab-panel am-active">
							<form style="margin-top: 0px;" method="post"
								...
								<div class="login-links">
									<label for="reader-me">
										<input id="reader-me" type="checkbox" checked="checked" />
										点击表示您同意商城《服务协议》
									</label>
		...
		<div class="footer ">
			<div class="footer-hd ">
				<p><a href="# ">恒望科技</a> <b>|</b> <a href="# ">商城首页</a> <b>|</b>
					<a href="# ">支付宝</a> <b>|</b> <a href="# ">物流</a></p>
			</div>
			<div class="footer-bd ">
				<p><a href="# ">关于恒望</a> <a href="# ">合作伙伴</a> <a href="# ">联系我们</a>
