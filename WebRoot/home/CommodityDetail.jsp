...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		function addToCart(){
			var commoditycount = document.getElementById("text_box").value;
			var comid = document.getElementById("comid").value;
			window.location="ShopcartServlet?action=addShopCart&comid="+comid+"&count="+commoditycount;
		}
	</script>
	</head>
	<body>
		<!--顶部导航条 -->
			...
			<!--悬浮搜索框-->
			<input type="hidden" id="comid" value="${commdetail.comid}">
			<input type="hidden" id="comid" value="${commdetail.inventory}">
			<div class="nav white">
			...
			<div class="nav-table">
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="<%=basePath%>images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="<%=basePath%>images/02.jpg" />
								</li>
								<li>
									<img src="<%=basePath%>images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
				...
				<div class="item-inform">
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<img alt="" src="${commdetail.picture}" />
							</div>
						</div>
					...
					<div class="clearfixRight">
						...
						<div class="tb-detail-list">
							...
							<div class="tb-detail-price">
								<li class="price iteminfo_price">
									<dt>促销价</dt>
									<dd><em>¥</em><b class="sys_item_price">${commdetail.price}</b>  </dd>                                 
								</li>
								<li class="price iteminfo_mktprice">
									<dt>原价</dt>
									<dd><em>¥</em><b class="sys_item_mktprice">${commdetail.price}</b></dd>									
								</li>
								<div class="clear"></div>
							</div>
							...
							<ul class="tm-ind-panel">
								<li class="tm-ind-item tm-ind-sellCount canClick">
									<div class="tm-indcon"><span class="tm-label">库存</span><span class="tm-count">${commdetail.inventory}</span></div>
								</li>
							</ul>
							<div class="clear"></div>
							...
							<dl class="iteminfo_parameter sys_item_specpara">
								<dt class="theme-login"><div class="cart-title">选择购买数量<span class="am-icon-angle-right"></span></div></dt>
								<dd>
									<!--操作页面-->
										...
										<div class="theme-popbod dform">
											<form class="theme-signin" name="loginform" action="" method="post">
												<div class="theme-signin-left">
													...
													<div class="theme-options">
														...
														<dd>
															...
															<input id="text_box" name="commoditycount" type="text" value="1" style="width:30px;" />
															<input id="add" class="am-btn am-btn-default" name="" type="button" value="+" />
															<span id="Stock" class="tb-hidden">库存<span class="stock">${commdetail.inventory}</span>件</span>
														</dd>
												...
												<div class="theme-signin-right">
													...
													<div class="text-info">
														<span class="J_Price price-now">${commdetail.price}</span>
														<span id="Stock" class="tb-hidden">库存<span class="stock">${commdetail.inventory}</span>件</span>
													</div>
												</div>
						...
						<div class="pay">
							<div class="pay-opt">
							<a href="<%=basePath%>home/home.jsp"><span class="am-icon-home am-icon-fw">首页</span></a>
							...
							<li>
								<div class="clearfix tb-btn tb-btn-basket theme-login">
									<a id="LikBasket" title="加入购物车" href="javascript:addToCart()"><i></i>加入购物车</a>
								</div>
							</li>
						</div>
							...
							<div class="am-tabs-bd">
								...
								<div class="am-tab-panel am-fade am-in am-active">
									<div class="J_Brand">
										...
										<div class="clear"></div>
										<ul id="J_AttrUL">
											<li title="">商品描述：&nbsp;${commdetail.describe}</li>
										</ul>
										<div class="attr-list-hd tm-clear">
											<h4>商品评论：</h4></div>
										<div class="clear"></div>
											...
											<div class="am-comment-main">
												...
												<header class="am-comment-hd">
													...
													<div class="am-comment-meta">
														...
														<!-- 评论者 -->
														评论于
														<time datetime="">${comment.createdate}</time>
													</div>
												</header>
									...
									<div class="details">
										...
										<div class="twlistNews">
											...
											<img src="<%=basePath%>images/tw2.jpg" />
											<img src="<%=basePath%>images/tw3.jpg" />
											<img src="<%=basePath%>images/tw4.jpg" />
											<img src="<%=basePath%>images/tw5.jpg" />
											<img src="<%=basePath%>images/tw6.jpg" />
											<img src="<%=basePath%>images/tw7.jpg" /> --%>
										</div>
									</div>
									<div class="clear"></div>
